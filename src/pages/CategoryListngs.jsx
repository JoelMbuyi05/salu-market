    ...
    return (
        <div className="min-h-screen bg-light-bg pb-24">
            ...
            <div className="bg-white px-4 py-3 flex items-center justify-between border-b border-border">
                {/* left — filter icon */}
                <button className="flex items-center gap-2 text-near-black text-sm font-medium">
                ...
                <select
                    ...
                    className="text-sm text-near-black font-medium bg-white border border-border rounded-lg px-3 py-1.5 outline-none"
                >
